...
public class AppConfig {
    ...
    // Input
    public String getInputType() { return getString("video.input.type", "folder"); }
    public String getInputFolder() { return getString("video.input.folder", "./videos"); }
    public String getInputUrl() { return getString("video.input.url", ""); }
    public String getInputUrlFile() { return getString("video.input.urlfile", ""); }
    public boolean isWatchEnabled() { return getBoolean("video.input.watch", true); }
    
    // Output
    public String getOutputDir() { return getString("video.output.dir", "./output"); }
    public boolean keepTranscript() { return getBoolean("video.output.keep.transcript", true); }
    public boolean keepRephrased() { return getBoolean("video.output.keep.rephrased", true); }
    
    // Processing
    public boolean isSequential() { 
        return "sequential".equalsIgnoreCase(getString("video.processing.mode", "sequential")); 
    }
    public int getThreads() { return getInt("video.processing.threads", 1); }
    ...
    public String getRephraseStyle() { return getString("video.rephrase.style", "professional"); }
    
    // Tool Paths
    public String getFfmpegPath() { return getString("tool.ffmpeg.path", "ffmpeg"); }
    public String getFfprobePath() { return getString("tool.ffprobe.path", "ffprobe"); }
    public String getPythonPath() { return getString("tool.python.path", "python3"); }
    public String getWhisperScript() { return getString("tool.whisper.script", "./whisper_transcribe.py"); }
    public String getWhisperModel() { return getString("tool.whisper.model", "base"); }
    public String getWhisperDevice() { return getString("tool.whisper.device", "cuda"); }
    public String getOllamaUrl() { return getString("tool.ollama.url", "http://localhost:11434"); }
    public String getOllamaModel() { return getString("tool.ollama.model", "llama3.1:8b"); }
    public String getPiperPath() { return getString("tool.piper.path", "piper"); }
    public String getPiperModel() { return getString("tool.piper.model", ""); }
    public String getPiperModelConfig() { return getString("tool.piper.model.config", ""); }
    
    // Temp & Cleanup
    public String getTempDir() { return getString("temp.dir", "./temp"); }
    public boolean cleanupDownloads() { return getBoolean("cleanup.downloads", true); }
    public boolean cleanupTempAudio() { return getBoolean("cleanup.temp.audio", true); }
    
    // Download
    public int getDownloadTimeout() { return getInt("download.timeout.seconds", 300); }
    public int getDownloadRetryCount() { return getInt("download.retry.count", 3); }
    
    // Logging
    public String getLogLevel() { return getString("logging.level", "INFO"); }
    public String getLogFile() { return getString("logging.file", "./logs/video-processor.log"); }
